...
<head>
    ...
    <script src="../../JavaScript/muroPropio.js"></script>
    <script src="../../JavaScript/jquery-1.12.3.min.js"></script>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="muroPropio.php">Perfil</a></li>
    ...
    <div class="list-group barra-der-lateral">
        ...
        <div class="row">
            <div class="thumbnail" id="cajaFoto">
                ...
                <div class="caption">
                    <h3>
                        <?php echo "" . $imagenUsuario[0] . " " . $imagenUsuario[1] ?>
                    </h3>
                    <p>
                        <?php echo "<b>Sexo</b>: " . $imagenUsuario[3]?></p>
                    <p>
                        <?php echo "<b>F.Nac:</b> " . $_SESSION['fechaNacimiento']?></p>

                    <form method="POST" enctype="multipart/form-data" action="../Base_de_datos/funcionesGenerales.php">
                        <input type="hidden" name="id-usuario" value="<?php echo $_SESSION['codigoUsuario'] ?>">
                        <!-- enves del numero tiene que ir el id de sesion-->
                        <div class="Uploadbtn">
                            <input type="file" class="input-upload" accept=".jpg, .png, .jpeg" name="foto-nueva" required/>
                            <span>cargar</span>
                        </div>
                        <br>
                        <input type="submit" name="cambioFotoPerfil" class="btn btn-primary" value="Cambiar foto" />
        ...
        <div id="publicacionAIntroducir">
            <h3 class="text-success">Publicaciones</h3>
                <form method="POST" action="publicacion.php">
                    <textarea class="form-control input-lg p-text-area" rows="2" placeholder="Que está pasando?" id="publicacionPublicacion"></textarea>
